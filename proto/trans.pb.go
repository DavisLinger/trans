...
func (m *BatchTranResp) Reset()         { *m = BatchTranResp{} }
func (m *BatchTranResp) String() string { return proto.CompactTextString(m) }
func (*BatchTranResp) ProtoMessage()    {}
func (*BatchTranResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_afbc80efa276a497, []int{2}
}

func (m *BatchTranResp) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_BatchTranResp.Unmarshal(m, b)
}
func (m *BatchTranResp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_BatchTranResp.Marshal(b, m, deterministic)
}
func (m *BatchTranResp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchTranResp.Merge(m, src)
}
func (m *BatchTranResp) XXX_Size() int {
	return xxx_messageInfo_BatchTranResp.Size(m)
}
func (m *BatchTranResp) XXX_DiscardUnknown() {
	xxx_messageInfo_BatchTranResp.DiscardUnknown(m)
}

var xxx_messageInfo_BatchTranResp proto.InternalMessageInfo

func (m *BatchTranResp) GetFileName() []string {
	if m != nil {
		return m.FileName
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BatchTranResp)(nil), "transport.batchTranResp")
}
...
var fileDescriptor_afbc80efa276a497 = []byte{
	...
	0x04, 0x66, 0x2b, 0xe9, 0x70, 0xf1, 0x22, 0x99, 0x5e, 0x5c, 0x80, 0xd7, 0x78, 0x90, 0xea, 0xa4,
	0xc4, 0x92, 0xe4, 0x8c, 0x90, 0xa2, 0xc4, 0x3c, 0x6c, 0xaa, 0x99, 0x91, 0x55, 0x1b, 0x75, 0x33,
	0x72, 0x21, 0xfc, 0x21, 0x64, 0xc5, 0xc5, 0x0a, 0xe6, 0x08, 0x89, 0xeb, 0xc1, 0x05, 0xf5, 0x90,
	0x7d, 0x26, 0x25, 0x81, 0x5d, 0xa2, 0xb8, 0x40, 0xc8, 0x89, 0x8b, 0x1b, 0x6c, 0x6f, 0x68, 0x81,
	0x4f, 0x7e, 0x62, 0x0a, 0x71, 0x26, 0xa0, 0x38, 0x54, 0x83, 0xd1, 0x89, 0x3b, 0x0a, 0xe1, 0x98,
	0x24, 0x36, 0x70, 0x30, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x58, 0x53, 0xde, 0xc7, 0x75,
	0x01, 0x00, 0x00,
}
...
func (*UnimplementedTransportServer) BatchUpLoad(srv Transport_BatchUpLoadServer) error {
